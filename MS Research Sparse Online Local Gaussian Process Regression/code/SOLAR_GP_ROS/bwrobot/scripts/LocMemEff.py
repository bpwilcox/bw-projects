...
#        pert = np.vstack((pert1,pert2,pert3))
    ...
    def jitROS(self,n,Y_init, deg = 5):
...
#        m_new.optimize(optimizer = 'rprop',messages=True)
#        m_new.optimize(optimizer ='bfgs' ,max_iters =1)
        m_new.optimize(messages = False)
#        m_new.pref
#        print(m_new.optimization_runs)
#        m_new.optimize(messages= False, max_iters=1)
